...
<section class="container-xxl my-4">
    <section class="row">
            ...
            <section id="slideshow" class="owl-carousel owl-theme">
                ...
                <section class="item">
                    <a class="w-100 d-block h-auto text-decoration-none" href="">
                        <img class="w-100 rounded-2 d-block h-auto" src="{{ asset('coustomer/images/slideshow/1.jpg') }}" alt="">
                    </a>
                </section>
        ...
        <section class="col-md-4 ps-md-1 mt-2 mt-md-0">
            <section class="mb-2"><a href="#" class="d-block"><img class="w-100 rounded-2" src="{{ asset('coustomer/images/slideshow/1.jpg') }}" alt=""></a></section>
            <section class="mb-2"><a href="#" class="d-block"><img class="w-100 rounded-2" src="{{ asset('coustomer/images/slideshow/1.jpg') }}" alt=""></a></section>
        </section>
    </section>
</section>
                    ...
                    <section class="brands dark-owl-nav owl-carousel owl-theme">
                        ...
                        <section class="item">
                            <section class="brand-item">
                                <a href="#">
                                    <img class="rounded-2" src="{{ asset($brand->logo) }}" alt="{{ asset($brand->name) }}">
                                </a>
                            </section>
                        </section>
